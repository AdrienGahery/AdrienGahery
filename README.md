...
I'm impressed with the possibilities Python libraries can provide to GIS data. Since my primary trade is the SQL, I want to pick the best out of both world: capabilities in database managment, and complex treatments&calculations. I'm currently setting a [repository](https://github.com/AdrienGahery/GIS-DataScience_Pipeline) focused on Geographical Data Science, bridging both worlds.
